...
public class TwitterProducerSafeCompression {

    private static final Logger LOG = LoggerFactory.getLogger(TwitterProducerSafeCompression.class);

    public TwitterProducerSafeCompression() {}

    public static void main(String[] args) {
        new TwitterProducerSafeCompression().run();
    }
